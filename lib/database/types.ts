...
/**
 * Review link citation from Gemini grounding metadata
 */
...
/**
 * Database representation of Product
 * Stores AI-analyzed product information with review summaries and citations
 */
export interface ProductRow {
  ...
  review_links: ReviewLink[]; // JSONB array
...
/**
 * Product data structure for frontend use
 */
...
/**
 * Converts ProductRow to Product format
 */
...
/**
 * Converts Product to database row format
 */
export function productToRow(product: Product): ProductRow {
  return {
    ...
    review_summary: product.reviewSummary || null,
    review_links: product.reviewLinks || [],
    last_scraped: product.lastScraped.toISOString(),
...
/**
 * Type for inserting a new Product into the database
 */
export type ProductInsert = Omit<ProductRow, 'id' | 'created_at' | 'updated_at'>;

/**
 * Type for updating an existing Product in the database
 */
export type ProductUpdate = Partial<Omit<ProductRow, 'id' | 'created_at' | 'user_id'>>;
